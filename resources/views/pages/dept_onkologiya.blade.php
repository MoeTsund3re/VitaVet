...
@section('content')
    ...
    <body>
        <div class="dept_banner" style="background:#059E8C">
            <div class="dept_banner_inner">
                <div class="dept_banner_text">
                    <p class="dept_banner_breadcrumb"><a href="services.html" style="color:#fff;opacity:0.7">Услуги</a> /
                        Онкология</p>
                    <h1 class="dept_banner_title" style="color:#fff">Онкологическое отделение</h1>
                    <p class="dept_banner_tagline" style="color:#fff;opacity:0.85">Раннее выявление и эффективное лечение
                        опухолей</p>
        ...
        <div class="dept_content">
            <div class="dept_desc">
                <p>Онкологическое отделение занимается диагностикой и лечением опухолевых заболеваний у животных. Мы
                    используем современные методы: хирургическое удаление, химиотерапию и комбинированные протоколы лечения.
                </p>
                <p>Ранняя диагностика существенно увеличивает шансы на выздоровление. Если вы заметили уплотнение, изменение
                    поведения или потерю веса у питомца — не откладывайте визит к врачу.</p>
            </div>

            <!-- НОВЫЙ БЛОК: Поддержка пациентов -->
            <div class="dept_support">
                <h3>Поддержка на всех этапах лечения</h3>
                <div class="support_grid">
                    <div class="support_card">
                        <div class="support_icon">📞</div>
                        <h4>Психологическая поддержка</h4>
                        <p>Консультации для владельцев, помощь в принятии решений</p>
                    </div>
                    <div class="support_card">
                        <div class="support_icon">🤝</div>
                        <h4>Группы взаимопомощи</h4>
                        <p>Общение с владельцами, прошедшими через похожий опыт</p>
                    </div>
                    <div class="support_card">
                        <div class="support_icon">📚</div>
                        <h4>Информационная поддержка</h4>
                        <p>Понятные материалы о каждом этапе лечения</p>
                    </div>
                </div>
            </div>
            ...
            <div class="dept_content">
                <div class="dept_desc">
                    <p>Стоматологическое отделение нашей клиники занимается профилактикой и лечением заболеваний полости рта
                        у
                        кошек и собак. Профессиональная чистка зубов, лечение кариеса, удаление зубов — всё выполняется под
                        общей анестезией для комфорта питомца.</p>
                    <p>По статистике, у 80% кошек и собак старше 3 лет обнаруживаются те или иные заболевания зубов.
                        Регулярные
                        осмотры помогут избежать серьёзных проблем.</p>
                </div>
        ...
        <div class="auth_drawer" id="authDrawer">
            ...
            <div class="auth_panel" id="regPanel" style="display:none">
                ...
                <div class="auth_form">
                    ...
                    <button class="auth_switch" onclick="switchToLogin()">Уже есть аккаунт?
