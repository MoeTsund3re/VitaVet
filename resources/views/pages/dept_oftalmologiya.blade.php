...
@section('content')
    ...
    <body>
        <div class="dept_banner" style="background:#38BDF8">
            <div class="dept_banner_inner">
                <div class="dept_banner_text">
                    <p class="dept_banner_breadcrumb"><a href="services.html" style="color:#1b1b29;opacity:0.7">Услуги</a> /
                        Офтальмология</p>
                    <h1 class="dept_banner_title" style="color:#1b1b29">Офтальмологическое отделение</h1>
                    <p class="dept_banner_tagline" style="color:#1b1b29;opacity:0.85">Бережём зрение ваших питомцев</p>
        ...
        <div class="dept_content">
            <div class="dept_desc">
                <p>Офтальмологическое отделение занимается диагностикой и лечением заболеваний глаз у кошек, собак и
                    экзотических животных. Мы используем специализированное оборудование: щелевую лампу, тонометр,
                    офтальмоскоп.</p>
                <p>Покраснение глаз, слезотечение, помутнение роговицы или снижение реакции на свет — повод срочно
                    обратиться к офтальмологу. Некоторые заболевания требуют помощи в течение нескольких часов.</p>
            </div>

            <!-- НОВЫЙ БЛОК: Почему мы? -->
            <div class="dept_whyus">
                <h3>Почему доверяют нам?</h3>
                <div class="whyus_grid">
                    <div class="whyus_item">
                        <div class="whyus_icon">👁️</div>
                        <h4>Оборудование премиум-класса</h4>
                        <p>Щелевая лампа, тонометр, офтальмоскоп — всё для точной диагностики</p>
                    </div>
                    <div class="whyus_item">
                        <div class="whyus_icon">🎓</div>
                        <h4>Специализация</h4>
                        <p>Только офтальмология — глубокая экспертиза в каждой процедуре</p>
                    </div>
                    <div class="whyus_item">
                        <div class="whyus_icon">🏥</div>
                        <h4>Собственный стационар</h4>
                        <p>Возможность круглосуточного наблюдения после операций</p>
                    </div>
                </div>
            </div>
