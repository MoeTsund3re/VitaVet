...
@section('content')
    ...
    <body>
        <div class="dept_banner" style="background:#718fa9">
            <div class="dept_banner_inner">
                <div class="dept_banner_text">
                    <p class="dept_banner_breadcrumb"><a href="{{ route('services') }}"
                            style="color:#fff;opacity:0.7">Услуги</a> / Терапия</p>
                    <h1 class="dept_banner_title" style="color:#fff">Терапевтическое отделение</h1>
                    <p class="dept_banner_tagline" style="color:#fff;opacity:0.85">Диагностика и лечение внутренних болезней
                    </p>
        ...
        <div class="dept_content">
            <div class="dept_desc">
                <p>Терапевтическое отделение — первая точка контакта вашего питомца с нашей клиникой. Врачи-терапевты
                    проводят первичный осмотр, назначают необходимые обследования и составляют план лечения.</p>
                <p>Мы занимаемся лечением болезней внутренних органов, инфекционных и паразитарных заболеваний, хронических
                    патологий. При необходимости направляем к узким специалистам.</p>
            </div>

            <div class="dept_care">
                <h3>Комплексная забота о вашем питомце</h3>
                <div class="care_grid">
                    <div class="care_item"><strong>❤️ Индивидуальный подход</strong>
                        <p>Каждый пациент получает персональный план лечения с учётом возраста, породы и состояния здоровья
                        </p>
                    </div>
                    <div class="care_item"><strong>📋 Прозрачность лечения</strong>
                        <p>Объясняем каждый шаг, показываем результаты анализов и отвечаем на все вопросы</p>
                    </div>
                    <div class="care_item"><strong>🕛 Круглосуточная поддержка</strong>
                        <p>Живой врач на связи до 3 часов ночи — проконсультируем по любым вопросам</p>
                    </div>
                </div>
            </div>
        ...
        <!-- AUTH DRAWER (такой же как в хирургии) -->
