...
@section('content')
    ...
    <body>
        <div class="dept_banner" style="background:#CEDE59">
            <div class="dept_banner_inner">
                <div class="dept_banner_text">
                    <p class="dept_banner_breadcrumb"><a href="{{ route('services') }}"
                            style="color:#1b1b29;opacity:0.7">Услуги</a> / Стоматология</p>
                    <h1 class="dept_banner_title" style="color:#1b1b29">Ветеринарная стоматология</h1>
                    <p class="dept_banner_tagline" style="color:#1b1b29;opacity:0.85">Здоровые зубы — здоровый питомец</p>
        ...
        <div class="dept_content">
            <div class="dept_desc">
                <p>Стоматологическое отделение нашей клиники занимается профилактикой и лечением заболеваний полости рта у
                ...
                <p>По статистике, у 80% кошек и собак старше 3 лет обнаруживаются те или иные заболевания зубов. Регулярные
                    осмотры помогут избежать серьёзных проблем.</p>
            </div>

            <div class="dept_prevention">
                <h3>Как сохранить зубы питомца здоровыми?</h3>
                <div class="prevention_grid">
                    <div class="prevention_card">
                        <div class="prevention_icon">🪥</div>
                        <h4>Чистка зубов 2-3 раза в неделю</h4>
                        <p>Используйте специальные щётки и пасты для животных</p>
                    </div>
                    <div class="prevention_card">
                        <div class="prevention_icon">🦴</div>
                        <h4>Специальные игрушки и лакомства</h4>
                        <p>Помогают механически очищать зубы от налёта</p>
                    </div>
                    <div class="prevention_card">
                        <div class="prevention_icon">🔍</div>
                        <h4>Регулярные осмотры</h4>
                        <p>Раз в 6 месяцев проверяйте полость рта у врача</p>
                    </div>
                </div>
            </div>
